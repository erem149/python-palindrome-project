...
print(timeit.timeit('test1()', globals=globals(), number = 190))
print(timeit.timeit('test2()', globals=globals(), number = 190))
print(timeit.timeit('test3()', globals=globals(), number = 190))