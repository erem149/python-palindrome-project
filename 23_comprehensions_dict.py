...
print(list(zip(movies, year))) # we get combined as tuple inside of list
...
print(n1)
n2 = [[name + "s favorite movie was" + movie + " from " + str(yr)] for name, movie, yr in zip(names, movies, year) if yr < 1981]
print(n2)